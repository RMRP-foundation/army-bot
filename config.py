...
SUPPLY_ITEMS = {
    ...
    "Прочее": ["Бодикамеры", "Патроны", "Материалы"],
}
...
SUPPLY_INFO_LINK = "https://discord.com/channels/1245655012550512670/1251166871064019015/1522124204743590030"
...
PROMOTION_NOTIFY_ROLES: dict[int, tuple[int, ...]] = {
    1: (1246114382208040970, 1246113946872840214, 1477926048745128048),  # ВА
    2: (1246114382208040970, 1246113946872840214, 1477925799205015582,
        1524846478856818977, 1524846485907181668),                       # ВК
    3: (1294219273031516261, 1246114041227640934),                       # РОиО
    4: (1246113944897323150, 1246114040024010752),                       # УВП
    5: (1246113945887182848, 1246114040758013952),                       # ССО
    6: (1246114039470227516, 1251045308729790556),                       # МР
    8: (1246114382208040970, 1246113946872840214,
        1524846478856818977, 1524846485907181668),                       # КМБ
}
